...
export const QUIZ_DATA: Quiz[] = [
  {
    quizId: 'typescript',
    milestone: 'Teammeeting',
    summary: 'Alle Hafenstädte sind schön. Aber wie schreibt man sie richtig?',
    image:
    ...
    questions: [
      {
        questionText: 'In welcher Stadt findet unser Teammeeting statt?',
        options: [
          { text: 'Willhelmshaven' },
          { text: 'Wilhelmshafen' },
          { text: 'Wilhelmshaven', correct: true },
          { text: 'Wilhelmshafen' },
        ],
        explanation:
